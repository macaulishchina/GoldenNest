  ...
  <div class="site-settings">
    <n-card title="🌐 网站配置" :bordered="false">
      <n-space vertical :size="24">
        ...
        <!-- PWA 说明 -->
        <n-card title="📱 添加到主屏幕说明" size="small" embedded>
          <n-space vertical :size="8">
            <n-text>上传图标并保存设置后，手机用户可以将网站添加到主屏幕：</n-text>
            <n-list>
              <n-list-item>
            ...
            <n-text depth="3" style="font-size: 12px">
              添加后，应用将使用上方配置的图标和名称显示在主屏幕上，打开时全屏显示，如同原生 App。
            </n-text>
          </n-space>
        </n-card>
      </n-space>
...
import { useMessage, NCard, NSpace, NButton, NUpload, NInput, NForm, NFormItem, NText, NIcon, NList, NListItem, NColorPicker } from 'naive-ui'
